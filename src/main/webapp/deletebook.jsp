...
<body>
	...
	<h3 class="welcome">
		...
		Welcome <span id="username"> <%=session.getAttribute("name")%>
			...
			class="fa-solid fa-magnifying-glass"></i> Search</a> </span> </span> <a
			href="http://localhost:8088/OnlineBookManagmentSystem/updatebook.jsp"
			class="btn btn-danger btn-sm ml-2"><i
			class="fa-solid fa-pen-to-square"></i> UpdateBook</a> </span>
			</span> <a
	...
	<div class="main-search-input-wrap">
		<form action="Controller" method="POST"
			class="main-search-input fl-wrap" style="margin-top: 10rem;">
			<div class="main-search-input-item">
				<input type="number" name="deleteID" placeholder="ID">
			</div>
			<button type="submit" name="action" value="deletebook"
				class="main-search-button">Delete</button>
		</form>
	</div>
