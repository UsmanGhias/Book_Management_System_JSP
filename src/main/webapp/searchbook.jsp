	...
	<div class="main-search-input-wrap">
		<form action="Controller" method="POST"
			...
			<div class="main-search-input-item">
				<input type="text" name="searchTitle" placeholder="Search Book">
			</div>
			<button type="submit" name="action" value="searchbook"
				class="main-search-button">Search</button>
		</form>
	</div>
	...
	<table class="table table-striped table-dark search_table">
		...
		<tbody>
			...
			<tr>
				...
				<td><%=temp.getGenre()%></td>
				<td><a href="https://<%=temp.getLink()%>" target="_blank"
					class="tapMe">Tap me</a></td>
			</tr>
